...
// C2Server represents the C2 server
...
func NewServer() *C2Server {
	...
	// Create API router
	apiRouter := api.NewRouter(listenerManager, moduleManager, taskManager)
...
func (s *C2Server) LoadConfig(configFile string) error {
...
func (s *C2Server) LoadModule(name, path string, loaderType string) error {
	if s.moduleManager == nil {
...
func (s *C2Server) InitModule(name string, params map[string]interface{}) error {
	if s.moduleManager == nil {
		return fmt.Errorf("module manager not initialized")
	}
...
func (s *C2Server) ExecModule(name, command string, args ...interface{}) (interface{}, error) {
	if s.moduleManager == nil {
...
func (s *C2Server) UnloadModule(name string) error {
	if s.moduleManager == nil {
		return fmt.Errorf("module manager not initialized")
	}
...
func (s *C2Server) ListModules() map[string]manager.ModuleInfo {
	if s.moduleManager == nil {
